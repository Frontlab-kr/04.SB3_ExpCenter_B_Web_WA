<template>
  <div>
    <div class="d-flex title-xxlarge">
      <h1 class="title-xxlarge" style="position: relative;z-index: 10;background-color: white;">Review</h1>
      <v-spacer></v-spacer>
      <v-btn @click="ShowDialog()"><v-icon aria-hidden="true" style="margin-right: 6px;" title="체험후기 게시글 작성 창 열기">mdi-pencil</v-icon>{{ $t("all_btn_write") }}</v-btn>
    </div>
      ...
      <v-data-table
        ...
        <template v-slot:default="props">
          <table class="nor_table_center">
            <caption id="table-caption" class="sr-only">Review table</caption>
            <thead>
              <tr>
