<template>
  <div>
    <div class="d-flex title-xxlarge">
      <h1 class="title-xxlarge" style="position: relative;z-index: 10;background-color: white;">체험후기</h1>
      <v-spacer></v-spacer>
      ...
      <v-data-table
        ...
        <template v-slot:default="props">
          <table class="nor_table_center">
            <caption id="table-caption" class="sr-only">체험후기 테이블</caption>
            <thead>
              <tr>
    ...
    <v-dialog aria-modal="true" @update:modelValue="DialogClose" v-model="bDialog" width="80%">
      <v-card class="pa-4 pl-6 pr-6">
        ...
        <div style="max-height: 80vh; overflow: auto;">
          <v-row class="ma-0">
            <v-col cols="12" md="4" sm="12">
              <M4_Input v-model="oEditItem.CRT_USER_ID" readonly :label="$t('all_table_header_5')"></M4_Input>
            </v-col>
            <v-col cols="12">
        ...
        <div class="d-flex flex-wrap mt-4">
          ...
          <input id="fileUpload" aria-hidden="true" type="file" ref="fileInput" style="display: none;" multiple @change="onFileSelected">
...
export default {
  ...
  methods : {
    ...
    GetBoardWithAuthInfo() {
      ...
      var posData = {
        BoardType : import.meta.env.VITE_BOARD_CASE_REV,
      ...
      axios
        ...
        .then(res => {
          if (res.data.ResultCd === "00") {
            ...
            EventBus.$emit("onShowMsg", {
              cSubTitle : "체험후기 조회 중 문제가 발생했습니다.",
        ...
        .catch(err =>{
          EventBus.$emit("onShowMsg", {
            cSubTitle : "체험후기 정보 조회 중 문제가 발생했습니다.",
            cTitle : "계속 지속될 경우 담당자에게 문의 바랍니다.",
            cMsg : `Error : ${err}`,
          });
        })
